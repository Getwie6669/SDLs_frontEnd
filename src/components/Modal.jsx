        ...
        <>
            {
                ...
                <div onClick={(e) => e.stopPropagation()} className={` bg-white rounded-md shadow px-16 py-8 transition-all duration-300 ${custom ? custom : "w-3/4 sm:w-1/3"} ${open ? "scale-100 opacity-100" : "scale-75 opacity-0"}`} >
                    {children}
                    </div>
                </div> 
            }
